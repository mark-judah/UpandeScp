        ...
        <div className="flex items-center gap-2.5 py-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:gap-0 group-data-[collapsible=icon]:py-0">
          ...
          <div
            className={cn(
              ...
              // `hidden` is not animatable, so the name vanished on the
              // first frame and the rail spent the next 260ms closing
              // over the space it left. Fading and collapsing instead
              // lets it leave WITH the rail rather than before it.
              // Animated by grid column, not by max-width. A max-width has to
              // resolve against the content, so for one frame the block took
