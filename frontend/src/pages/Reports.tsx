...
const REPORTS: ReportSpec[] = [
  ...
  },
  {
    ...
    extraDownload: {
      ...
      url: ({ farm, week }) =>
        `/api/method/upande_scp.serverscripts.send_fcm_weekly_excel_report.download_scouting_entries_xlsx?farm=${encodeURIComponent(farm || "")}&week=${encodeURIComponent(week || "")}`,
    },
  },
];
