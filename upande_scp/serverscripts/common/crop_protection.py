...
# mona still calls this "Spray Plan Settings"; kaitet renamed it to "Scouting
# and Crop Protection Settings" as part of a wider settings convergence that
# also moves the store fields into Farm Store Mapping. This constant is the ONLY
# permitted divergence from kaitet's copy of this file.
