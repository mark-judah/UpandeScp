...
def get_settings_bundle() -> dict:
    ...
    return {
        "spray_plan": {
            ...
            "default_chemical_difference_account": settings.default_chemical_difference_account or "",
            ...
            "stamp_transfer_cost_center": int(settings.stamp_transfer_cost_center or 0),
...
def save_spray_plan_settings(payload) -> dict:
    ...
    scalar_fields = [
        ...
        "default_chemical_difference_account",
        "spray_raw_chemical_account",
        "spray_tank_mix_account",
        "spray_expense_account",
        "stamp_transfer_cost_center",
        "bypass_owner_check",
